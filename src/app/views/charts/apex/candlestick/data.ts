...
export const simpleCandlestickChart: () => ApexOptions = () => ({
    chart: {
        height: 350,
        type: 'candlestick',
        toolbar: {show: false}
...
export const xAxisCandlestickChart: () => ApexOptions = () => ({
    series: [{
        name: 'candle',
        data: [{
...
export const candlestickWithLineChart: () => ApexOptions = () => ({
    series: [{
        name: 'Line',
        type: 'line',
        data: [{
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: getColor('success'),   // ✅ Use string, not array
                downward: getColor('danger')   // ✅ Use string, not array
            }
        }
    },
    tooltip: {
