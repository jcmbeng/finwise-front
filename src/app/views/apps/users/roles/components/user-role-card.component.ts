  ...
  template: `
      <div class="card">
          <div class="position-absolute top-0 end-0" style="width: 180px;">
              <svg style="opacity: 0.075; width: 100%; height: auto;" width="600" height="560" viewBox="0 0 600 560"
                   fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_948_1464)">
                      <mask id="mask0_948_1464" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                      ...
                      <mask id="mask1_948_1464" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                            width="600" height="1200">
                          <path d="M0 0L0 1200H600L600 0H0Z" fill="white"></path>
                      </mask>
                      <g mask="url(#mask1_948_1464)">
                          <path
                              ...
                              stroke="#089df1" stroke-width="2" stroke-miterlimit="10"></path>
                          <path
          ...
          <div class="card-body d-flex flex-column justify-content-between">
              ...
              <div class="d-flex justify-content-between align-items-center">
                  ...
                  <a routerLink="/users/role-details" class="btn btn-sm btn-outline-primary rounded-pill">Details</a>
              </div>
          </div>
      </div>
  `,
